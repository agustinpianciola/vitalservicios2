...
###Agregado Zolvant
    ...
    def _onchange_fiscal_position_allowed_journal(self):
        ...
        if self.journal_id.es_canal_2 == True:
            ...
            #raise Warning(self.fiscal_position_id.name)
            ...
            #self.partner_id, delivery_id=self.partner_id)
        ...
        def _get_payment_terms_account(self, payment_terms_lines):
                        ...
                        if self.fiscal_position_id:
                            ...
                            if self.partner_id:
                                ...
                                #si raise Warning ("Se actualizara el calculo impositivo segun la posicion fiscal")
                                if self.is_sale_document(include_receipts=True):
                                    #raise Warning (self.fiscal_position_id.receivable_account_id.name)
    ...
    def action_register_payment_group(self):
        ...
        return {
            ...
            'context': {
                ...
                'default_es_canal_2': self.journal_id.es_canal_2,
                'default_pago_directo': True,
            },
        }
