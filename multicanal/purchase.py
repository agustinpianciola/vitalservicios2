...
class purchase_order(models.Model):
    ...
    def _prepare_sale_order_data(self, name, partner, company, direct_delivery_address):
        ...
        domain_fiscal_position_1 = [('company_id', '=', company.id), ('es_canal_2', '=',False)]
        domain_fiscal_position_2 = [('company_id', '=', company.id), ('es_canal_2', '=',True)]
        if self.fiscal_position_id.es_canal_2 == True:
